...
public class Method09 {
	...
	public static void main(String[] args) {
		...
		max(20, 56, 35);  
		// 리턴이 있는 메서드를 호출하고 그 리턴값을 받아줄수 있는 변수를 쓰지 않았을때
		...
		// 메서드가 호출되고 리턴되는 순간 그 리턴값은 메서드호출문구를 대신하여 값으로 
		// 다른 연산에 참여 합니다( = , + , - , * , / 등)
	...
	public static int squar(int n) {
		int s = n * n;
		return s;
		// 메서드가 실행된 결과를 되돌려주는 명령 & 호출한곳으로 되돌아가는 명령 : return
		// 그동안 형식적으로 void 라고 썼던곳에 리턴되는 값의 자료형을 써줍니다
		// 리턴 자료형은 메서드 생성과 동시에 고정됩니다.
