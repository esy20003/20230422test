...
insert into testtable values(1, 'abc',2002,12345,2000);
select * from testtable;
update testtable set subject = 'bbc';
...
-- 기본키 외래키 속성이 그데로 바뀐 이름으로 승계되어 자동 적용됩니다
...
-- check( promotion_id>=10000 and promotion_id<=99999 )
