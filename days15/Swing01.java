...
class ButtonTest extends JFrame{
	...
	ButtonTest(){
		...
		// 현재 윈도우 종료시 프로그램까지 종료하는걸로 설정
		setVisible(true);  // 화면에 윈도우를 출현 시키는 메서드. 보통 가장마지막에 표시
	}
