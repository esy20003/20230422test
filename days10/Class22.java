...
class StaticA{
	int num;  // 인스턴스 멤버 변수 - 멤버변수이면서 static 이 아닌 변수(동적 멤버변수)입니다
	static int number = 100; // static 멤버 변수 - 얘도 멤버변수입니다.  static 멤버변수(정적 멤버변수)입니다
}
...
public class Class22 {
	...
	public static void main(String[] args) {
		...
		// 3. 인스턴스 변수는 객체 생성때마다 각각의 객체안에 만들어져서 객쳇의 갯수 만큼 생성되지만, 
		//    스태틱변수는 프로그램 전체를 통틀어 한개만 만들어지고 
		//    그 값도 객체와 상관없이 현재값이 변경전 또는 프로그램 끝날때까 유지됩니다.
		System.out.println();
		StaticA a2 = new StaticA(); 
		a2.num = 200;
		System.out.println("a2  객체의 인스턴스 멤버변수 값 : " + a2.num);
		StaticA a3 = new StaticA(); 
		a3.num = 300;
		System.out.println("a3  객체의 인스턴스 멤버변수 값 : " + a3.num);
		...
		// private로 보호된 static 변수는  getter 와 setter 를  static 으로 따로 제작해서  
		// 값을 저장하거나 얻어 냅니다.
